        ...
        <Card>
          ...
          <div className="text-center mb-6">
            <div className="mb-6">
              ...
              <p className="text-lg mb-2 text-[#4A4A5E]">Il tuo viaggio si ferma qui</p>
        ...
        <Card>
          ...
          <div className="text-center mb-6">
            <div className="mb-6">
              ...
              <p className="text-xl mb-4 text-[#2D2D3F]">
  ...
  if (gameState.phase === 'answering') {
    return (
      <PageLayout>
        <Card>
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4 p-3 bg-gradient-to-r from-[#E8D4B8] to-[#D4B896] rounded-lg border border-[#D4AF37]">
            ...
            <Title level={gameState.currentLevel} className="text-lg">
              {currentQuestion?.text}
            </Title>
            <div className="text-center p-3 bg-[#E8D4B8] rounded-lg border-2 border-[#D4AF37] mb-2">
      ...
      <PageLayout>
        <Card>
          <div className="mb-6">
            ...
            <div className="text-center p-3 bg-[#E8D4B8] rounded-lg border-2 border-[#D97757] mb-2">
              <p className="text-[#2D2D3F] font-semibold text-sm">
        ...
        <Card>
          ...
          <div className="text-center mb-6">
            <div className="mb-6 space-y-3">
              <div className="p-4 bg-[#E8D4B8] rounded-lg border-2 border-[#D4AF37]">
                <p className="text-[#4A4A5E] text-sm mb-1">🛡️ Il Custode ha risposto:</p>
                <p className="text-[#2D2D3F] font-bold text-lg">{gameState.selectedAnswer}</p>
              </div>
              <div className="p-4 bg-[#E8D4B8] rounded-lg border-2 border-[#D97757]">
                <p className="text-[#4A4A5E] text-sm mb-1">🔍 L'Esploratore ha indovinato:</p>
